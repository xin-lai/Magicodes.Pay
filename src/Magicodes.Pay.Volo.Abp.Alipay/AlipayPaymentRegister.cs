...
namespace Magicodes.Pay.Abp.Alipay
{
    ...
    {
        public AlipayPaymentRegister(IServiceProvider serviceProvider, IJsonSerializer jsonSerializer, ISettingProvider settingProvider) : base(serviceProvider, jsonSerializer, settingProvider)
        {
        }
